...
def test_docker():
    ...
    os.system("docker run -d -p 5000:5000 --name flask_app_test_container flask-score-app")
    time.sleep(3)
    
    response = requests.post(
        "http://localhost:5000/score",
        json={"text": "claim 1000 rs worth of free gifts", "threshold": 0.1}
    )
    ...
    os.system("docker stop flask_app_test_container")
    os.system("docker rm flask_app_test_container")
